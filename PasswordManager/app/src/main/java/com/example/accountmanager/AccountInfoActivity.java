...
public class AccountInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeTextColor();
        Animation fabPop = AnimationUtils.loadAnimation(AccountInfoActivity.this, R.anim.fab_pop);
                ...
                new AlertDialog.Builder(AccountInfoActivity.this)
                        ...
                        .setPositiveButton("保存", (dialogInterface, i) -> {
                            ...
                            if (AutoSync) {
                                ...
                                new DropboxManager(AccountInfoActivity.this, token);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        new Handler().post(() -> {
            ...
            MaterialShowcaseSequence sequence = new MaterialShowcaseSequence(AccountInfoActivity.this, SHOWCASE_ID);
            sequence.setConfig(config);

            //tutorial
            sequence.addSequenceItem(
                    new MaterialShowcaseView.Builder(AccountInfoActivity.this)
                            .setTarget(fab)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        Intent intent = new Intent(getApplication(), CropImageActivity.class);
    ...
    private void openImageFile() {
        if (ContextCompat.checkSelfPermission(
        ...
        } else if (ActivityCompat.shouldShowRequestPermissionRationale(AccountInfoActivity.this,
            ...
            new AlertDialog.Builder(AccountInfoActivity.this)
                    ...
                    .setPositiveButton("確認", (dialogInterface1, i1) -> ActivityCompat.requestPermissions(AccountInfoActivity.this,
    ...
    private void pickColor() {
        Intent intent = new Intent(getApplicationContext(), ColorPalettActivity.class);
