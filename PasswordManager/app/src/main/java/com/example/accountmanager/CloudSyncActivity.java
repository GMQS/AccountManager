...
public class CloudSyncActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mPref.contains("access_token")) {
            new AlertDialog.Builder(CloudSyncActivity.this)
                    .setMessage("最初にブラウザでDropBoxのフォルダアクセスを許可してください。")
                    .setPositiveButton("確認", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            mDropboxManager = new DropboxManager(CloudSyncActivity.this);
                    ...
                    .setOnCancelListener(new DialogInterface.OnCancelListener() {
                        ...
                        public void onCancel(DialogInterface dialogInterface) {
                            if (First && !Restore) {
                                Toast.makeText(CloudSyncActivity.this, "接続に失敗したためサービスを利用できません", Toast.LENGTH_SHORT).show();
            ...
            mDropboxManager = new DropboxManager(CloudSyncActivity.this, token);
            Access = true;
        }
                    ...
                    new AlertDialog.Builder(CloudSyncActivity.this)
                            ...
                            .setNegativeButton("キャンセル", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                                    if (Restore) {
                                        intent = new Intent(getApplicationContext(), PasscodeActivity.class);
                                    }
                                    startActivity(intent);
                                    finish();
                                }
